...
func main() {
	fmt.Println("**NOTE** Remember that you must set the env variables to get access to aws account: AWS_ACCESS_KEY_ID AWS_SECRET_ACCESS_KEY")
	listResources()
}
